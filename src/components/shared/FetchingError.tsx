...
const FetchingError = ({ message }: { message: string }) => {
  return (
    <Card className='flex h-full items-center bg-gray-100'>
      <div className='container flex flex-col items-center justify-center px-5 text-gray-700 md:flex-row'>
        <div className='grid max-w-md gap-5'>
          ...
          <p className='text-xl font-light  md:text-3xl'>{message}</p>
        ...
        <div className='max-w-lg'>
          ...
          >
            ...
            <path
              className='fill-[#d6b49a] stroke-black [stroke-linecap:round] [stroke-linejoin:round] [stroke-width:3px]'
            ...
            />
            <ellipse
              className='cls-2 fill-[#020202] stroke-black [stroke-miterlimit:10] [stroke-width:3px]'
              cx='748.2'
              cy='816.89'
              rx='202.22'
              ry='30.98'
            ...
            />
            <path
              className='cls-3 fill-[#818181] [stroke-miterlimit:10] [stroke-width:3px] [stroke:#191818]'
            ...
            />
            <path
              className='cls-4 fill-[#dcdbda] stroke-black [stroke-miterlimit:10] [stroke-width:3px]'
            ...
            />
            <path
              className='cls-5 fill-[#4ea7f1] stroke-black [stroke-miterlimit:10] [stroke-width:3px]'
            ...
            />
            <path
              className='cls-6 fill-[#f8f3ed] stroke-black [stroke-miterlimit:10] [stroke-width:3px]'
            ...
            />
            <path
              className='cls-7 fill-[#333] [stroke-miterlimit:10] [stroke-width:3px] [stroke:#191818]'
            ...
            />
            <path
              className='cls-8 fill-none [stroke-linecap:round] [stroke-linejoin:round] [stroke-width:3px] [stroke:#191818]'
            ...
            />
            <circle
              className='cls-9 fill-[#f8f59c] [stroke-miterlimit:10] [stroke-width:3px] [stroke:#191818]'
              cx='1355'
              cy='991'
              r='31.5'
            />
            <path
              className='cls-10 fill-[#f3d2c9] stroke-black [stroke-miterlimit:10] [stroke-width:3px]'
            ...
            />
            <path
              className='cls-11 fill-[#f3d2c9] stroke-black [stroke-linecap:round] [stroke-linejoin:round] [stroke-width:3px]'
            ...
            />
            <circle
              className='cls-12 [stroke-miterlimit:10] [stroke-width:3px] [stroke:#191818]'
              cx='1355'
              cy='991'
              r='22.5'
            />
            ...
            />
            <path
              className='cls-10 fill-[#f3d2c9] [stroke-miterlimit:10] [stroke-width:3px]'
            ...
            />
            <path
              className='cls-13 fill-none stroke-black [stroke-linecap:round] [stroke-linejoin:round] [stroke-width:3px]'
            ...
            />
            <path
              className='cls-14 fill-[#f8f3ed] stroke-black [stroke-linecap:round] [stroke-linejoin:round] [stroke-width:3px]'
            ...
            />
            <path
              className='cls-15 fill-[#8bb174] stroke-black [stroke-miterlimit:10] [stroke-width:3px]'
            ...
            />
            <path
              className='cls-16 fill-[#333] [stroke-linecap:round] [stroke-linejoin:round] [stroke-width:3px] [stroke:#191818]'
            ...
            />
            <path
              className='cls-17 fill-[#da4e22] stroke-black [stroke-miterlimit:10] [stroke-width:3px]'
