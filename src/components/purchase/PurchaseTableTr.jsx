    ...
    <tr>
      ...
      <td>
        <div className="grid grid-cols-2 gap-1 w-[60px]">
          ...
          <Tooltip content="Return" animation="duration-500">
            <div className="actionBtn bg-teal-600/20 text-teal-600 hover:bg-teal-600 hover:text-white">
              <TfiBackLeft />
            </div>
          </Tooltip>
...
export default PurchaseTableTr;
