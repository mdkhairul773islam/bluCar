...
const AddPurchaseReturnTableForm = () => {
  return (
    <form className='flex flex-col gap-8'>
      ...
      <div className='ml-auto flex max-w-[600px] flex-col gap-3'>
        ...
        <div className='grid grid-cols-[140px_1fr] items-center gap-4'>
          ...
          <Input type='number' defaultValue={0.0} name='grand_total' readOnly />
        </div>
...
export default AddPurchaseReturnTableForm
