...
import { HighestSale, columns } from './_components/columns'

export const metadata: Metadata = {
  title: 'Highest Sale Product'
}

async function getData(): Promise<HighestSale[]> {
  return [
    {
      id: '1',
...
const HighestSaleProductPage = async () => {
  ...
  return (
    <>
      ...
      {/* Panel Header */}
      <PanelHeader title='Highest Sale Product'>
      ...
      {/* Highest Sale Product Table */}
      <DataTable data={data} columns={columns} />
    </>
  )
}

export default HighestSaleProductPage
