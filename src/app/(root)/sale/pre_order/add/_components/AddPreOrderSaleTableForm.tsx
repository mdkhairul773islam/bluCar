...
const AddPreOrderSaleTableForm = () => {
      ...
      <div className='grid gap-4 md:grid-cols-2'>
        <div className='flex flex-col gap-3'>
          ...
          <div className='grid grid-cols-[100px_1fr] items-center gap-4'>
            <Label className='text-right'>PreOrderSale Type</Label>
            <Select defaultValue='Cash'>
              <SelectTrigger>
                <SelectValue placeholder='Select PreOrderSale Type' />
              </SelectTrigger>
              <SelectContent>
                {[
                  {
...
export default AddPreOrderSaleTableForm
