    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)}>
        <div className='grid gap-4 py-4'>
          ...
          {/* Field of fixed Asset */}
          <FormField
            control={form.control}
            name='field_name'
            render={({ field }) => (
              <FormItem>
                <FormLabel>Field of fixed Asset</FormLabel>
                <Select
                  onValueChange={field.onChange}
                  defaultValue={field.value}
                >
                  <FormControl>
                    <SelectTrigger>
                      <SelectValue placeholder='Select a field of fixedAsset' />
                    </SelectTrigger>
                  </FormControl>
                  <SelectContent>
                    {[
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input type='number' placeholder='Pcs' {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
